Shader "Inception-Fx/Blend Turbulence" {
Properties {
    ...
    _BlendFactor ("BlendFactor", float) = .3
    _BlendPow ("BlendPow", int) = 4
}
SubShader { 
	...
	Pass
	{
		...
		fixed4 frag (v2f i) : COLOR
		{
			...
			base = base*base;
			fixed4 c = base*_BlendFactor*pow(blendc,_BlendPow)+ base*(fixed4(1,1,1,1)- blendc);
			return c ;
		}
		ENDCG
	}
